...
////////////////////////////////////////////////////페이징
 ...
 // 최대 가격순  커리
  $query2 = "SELECT @rownum:=@rownum+1,m_num,avg_price,m_dates,grade,marketname,maxprice,minprice,m_standard,detail_name FROM all_market_tbl,(SELECT@rownum:=0)TMP  WHERE  marketname= '$marketname' AND detail_name='$detail_name' AND grade='$grade'AND m_standard='$m_standard' LIMIT $start,$page_num ";
