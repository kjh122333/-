...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            button: function(options) { return 'íŒŒì¼ ' + (options.limit == 1 ? 'File' : 'ì„ íƒ'); },
            feedback: function(options) { return 'íŒŒì¼ì„ ' + (options.limit == 1 ? 'file' : '') + ' ì„ íƒí•˜ì—¬ ì£¼ì„¸ìš”'; },
            feedback2: function(options) { return options.length + ' ' + (options.length > 1 ? ' ê°œì˜' : ' ê°œì˜') + ' íŒŒì¼ì´ ì„ íƒ ë˜ì—ˆìŠµë‹ˆë‹¤.'; },
            drop: 'Drop the files here to Upload',
            paste: '<div class="fileuploader-pending-loader"><div class="left-half" style="animation-duration: ${ms}s"></div><div class="spinner" style="animation-duration: ${ms}s"></div><div class="right-half" style="animation-duration: ${ms}s"></div></div> Pasting a file, click here to cancel.',
            removeConfirmation: 'ì„ íƒë˜ì–´ìžˆëŠ” íŒŒì¼ì„ ì§€ìš°ì‹œê² ìŠµë‹ˆê¹Œ?',
            errors: {
